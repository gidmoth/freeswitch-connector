...
# cleaner:
curl -u teamuser1:napw --header "Content-Type: application/json" -X POST --data '[{"name": "stefan", "context": "team", "email": "foo@bar.baz", "polymac": "0004f2145497"}]' https://fcos.c8h10n4o2.news/api/users/add
